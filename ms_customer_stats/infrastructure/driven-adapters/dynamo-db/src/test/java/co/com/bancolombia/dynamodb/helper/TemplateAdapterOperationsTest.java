...
import co.com.bancolombia.dynamodb.CustomerStatsAdapter;
...
class TemplateAdapterOperationsTest {
    ...
    void testSave() {
        ...
        CustomerStatsAdapter customerStatsAdapter =
                new CustomerStatsAdapter(dynamoDbEnhancedAsyncClient, mapper);

        StepVerifier.create(customerStatsAdapter.save(modelEntity))
                .expectNextCount(1)
                .verifyComplete();
    }
    ...
    void testGetById() {
        ...
        StepVerifier.create(customerStatsAdapter.getById("id"))
                .expectNext("value")
                .verifyComplete();
    }
    ...
    void testDelete() {
        ...
        StepVerifier.create(customerStatsAdapter.delete(modelEntity))
                .expectNext("value")
                .verifyComplete();
    }
}